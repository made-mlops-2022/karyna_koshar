...
with DAG(
    ...
    validate = DockerOperator(
        ...
        command="--input-dir /data/split/{{ ds }} --model-dir /data/models/{{ ds }} --output-dir /data/metrics/{{ ds }}",
        task_id="airflow_validate",
        do_xcom_push=False,
        auto_remove=True,
        network_mode="host",
        mounts=[
    ...
    [wait_data, wait_target] >> preprocess_data >> split_data >> train >> validate
